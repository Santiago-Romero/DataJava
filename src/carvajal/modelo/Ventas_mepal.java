 ...
 */
public class Ventas_mepal {

    public boolean error = false;
    ArrayList<String> clientes = new ArrayList<String>();
    int cantidadClientes;
    String productos[];
    String sucursal[] = {"Bogota", "Medellin", "Barranquilla", "Cali", "Cartagena", "Eje Cafetero"};

    public Ventas_mepal(int cantRegistros) {
        cargarClientes();
    ...
    public void cargarProductos(int cantRegistros) {
        ...
        if (!error) {
            ResultSet rs = con.consulta("SELECT * FROM productos_mepal");
    ...
    public void generar(int cantRegistros) {
        if (!error) {
            ...
            int dia, mes, anio;
            int id = 1132;
            File_Ventas_mepal fvm = new File_Ventas_mepal();
            fvm.crear();
            ...
            if (!fvm.error) {
                ...
                for (int i = 0; i < cantRegistros; i++) {
                    ...
                    ale = (int) (Math.random() * 25);//selecciona un producto
                    ...
                    ale = (int) (Math.random() * 6);//selecciona una sucursal
                    registro += sucursal[ale] + ";";

                    System.out.println(registro);
                    fvm.guardar(registro);
                    id++;
                }//fin del for
        ...
        //File_Ventas_mepal_DB lfcdb = new File_Ventas_mepal_DB("Ventas_mepal.csv");
        //lfcdb.guardar();
    }
