...
public class Ventas_propal {
    ...
    public Ventas_propal(int cantRegistros) {
        cargarClientes();
    ...
    public void cargarProductos(int cantRegistros) {
        ...
        if (!error) {
            ResultSet rs = con.consulta("SELECT * FROM productos_propal");
    ...
    public void generar(int cantRegistros) {
        if (!error) {
            ...
            int dia, mes, anio;
            int id = 1132;
            File_Ventas_propal fvp = new File_Ventas_propal();
            fvp.crear();
            ...
            if (!fvp.error) {
                ...
                for (int i = 0; i < cantRegistros; i++) {
                    ...
                    ale = (int) (Math.random() * 5);//selecciona un producto
                    registro += productos[ale] + ";";

                    ale = 100000 + (int) (Math.random() * (1000000 - 100000));
        ...
        //File_Ventas_propal_DB lfcdb = new File_Ventas_propal_DB("Ventas_propal.csv");
        //lfcdb.guardar();
    }
