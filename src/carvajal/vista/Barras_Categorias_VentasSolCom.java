...
public class Barras_Categorias_VentasSolCom extends ApplicationFrame {

    public ChartPanel panel;
    public JFreeChart chart;
    int categoria1, categoria2, categoria3, categoria4;

    public Barras_Categorias_VentasSolCom(String title) throws SQLException {
        super(title);
    ...
    private CategoryDataset crearDataset() throws SQLException {
        ...
        if (!error) {
            ...
            if(rs.getInt(3)==(8)) categoria3+=rs.getInt(4);
            if(rs.getInt(3)==(9)) categoria3+=rs.getInt(4);
        ...
        con.cerrarConsulta();
        con.desconectar();
        dataset.setValue(categoria1, "Ventas", "Mercadeo");
        dataset.setValue(categoria2, "Ventas", "Datos");
        dataset.setValue(categoria3, "Ventas", "Impresión");
        dataset.setValue(categoria4, "Ventas", "Electrónicos");
